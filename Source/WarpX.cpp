...
WarpX::ReadParameters ()
{
...

    {
        ...
        has_max_step=utils::parser::queryWithParser(pp, "max_step", max_step);
...

    {
        ...
        if(max_level>0){
            const auto end_fine_patch_defined=utils::parser::queryWithParser(pp_warpx,"end_fine_patch_step", end_fine_patch_step);
